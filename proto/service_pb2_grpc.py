...
class ImageServiceStub(object):
    ...
    def __init__(self, channel):
        ...
        self.UploadImage = channel.unary_unary(
                ...
                response_deserializer=service__pb2.UploadImageResponse.FromString,
                _registered_method=True)
        self.PredictImage = channel.unary_unary(
                '/ImageService/PredictImage',
                request_serializer=service__pb2.ImageRequest.SerializeToString,
                response_deserializer=service__pb2.PredictImageResponse.FromString,
                _registered_method=True)
...
def add_ImageServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'UploadImage': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=service__pb2.UploadImageResponse.SerializeToString,
            ),
            'PredictImage': grpc.unary_unary_rpc_method_handler(
                    servicer.PredictImage,
                    request_deserializer=service__pb2.ImageRequest.FromString,
                    response_serializer=service__pb2.PredictImageResponse.SerializeToString,
            ),
    }
...
class ImageService(object):
    ...
    def UploadImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            service__pb2.UploadImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
    ...
    def PredictImage(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            '/ImageService/PredictImage',
            service__pb2.ImageRequest.SerializeToString,
            service__pb2.PredictImageResponse.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
